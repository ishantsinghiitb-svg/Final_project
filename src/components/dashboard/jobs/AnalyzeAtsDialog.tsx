...
//
// Credit-spending confirmation for the ATS Compatibility analysis — no auto-run,
// ever. Deliberately the same fixed-overlay/gradient-strip convention as the
// Module 6B AnalyzeMatchDialog (which is frozen, so this is a parallel copy, not
// a shared edit) so the dashboard's modals keep feeling like one system.
...
export function AnalyzeAtsDialog({
  open,
  reAnalyze,
  creditsRemaining,
  isPending,
  ...
  const title = reAnalyze ? "Re-analyze ATS Compatibility" : "Analyze ATS Compatibility";
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="analyze-ats-title"
    >
      <div
